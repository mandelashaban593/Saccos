...
.bottom-left {
  ...
  <div class="container">
  <img src="img/DevelopmentLoan.jpg" alt="Snow" style="width:100%;height: 300px;">
...
<div class="team-six" style="margin-left: 100px;width: 300px;margin-right: 100px;background-color:#2F409C;color: #FFFFFF;">
<div class="row offs1">
<?php
$query5 = "select * FROM  banking";
...
<div class="caption" style="background-color:#2F409C;width: 300px;font-size: 16px;color: #FFFFFF;border: 0px;">
 <h4 style="text-transform: uppercase;color: #FCF20C;"> 
<?=$data5['shortheading']?><br/>
</h4> 

<p style=""> <?=$data5['subdescribe']?>
