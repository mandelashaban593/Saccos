...
.bottom-left {
  ...
  <div class="container">
  <img src="img/document.jpg" alt="Snow" style="width:100%;height: 300px;">
...
<div class="row offs1">
<?php
$query5 = "select * FROM  files";
$runquery5= mysqli_query($db,$query5);
while($data5=mysqli_fetch_array($runquery5)){
?>
<div class="col-md-4 col-xs-12  col-md-6 ">
<div class="thumbnail">
...
<div class="caption" style="background-color:#2F409C;font-size: 16px;color: #FFFFFF;border: 0px;">
 <h4 style="text-transform: uppercase;color: #FCF20C;"> <br/>
</h4> 
<a href="document.php?file_id=<?php echo $data5['id'] ?>"><?=$data5['subheading']?></a>
<p style=""> 
</p>
</div>
</div>
