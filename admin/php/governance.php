governance.php<h2>Edit Governance Section</h2>
 <?php
        session_start();
         if(isset($_GET['msg'])){
...
?>     <form method="post" action="php/ugovernance.php">
         <div class="form-row">
    ...
    <label for="bd">Date of Formation</label>
    ...
    <input type="text" name="website" value="<?=$data['website']?>" class="form-control" id="website" placeholder="https://www.devninja.com">
         ...
         <hr>
         <h4 ID="skillsection">Membership requirements</h4>
