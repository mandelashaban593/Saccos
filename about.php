...
<head>
<meta charset="utf-8">
<title>Moto consulting Free HTML5 responsive Template | webthemez</title>
...
<div id="wrapper">
	...
	<div class="container">
					...
					<div class="about">
						...
						<div class="row"> 
							<div class="col-md-12"> 
									<h3>Who We Are <span class="color">TEAM</span></h3>
									<p>SOur  (Sacco)  is a fully registered work based Society whose mem­bership is composed of ONLY members of staff working for our  Office. It was registered with the Registrar of Co-operatives in 2021 under Reg.No.699633 . This institution is fully owned, controlled and used by fully paid up members. Membership is open and voluntary to all President’s Office staff.</p>
						...
						<div class="row">
							<div class="col-md-4">
								...
								<p>To offer quality and timely financial services to its eligible members <br/><br/></p>
							</div>
							<div class="col-md-4">
								<div class="block-heading-two">
									<h3><span></span></h3>
									 ...
									 <div class="panel-heading">
										<h4 class="panel-title">
										  <a data-toggle="collapse" data-parent="#accordion-alt3" href="#collapseTwo-alt3">
											<i class="fa fa-angle-right"></i> Aims and objectives
										  </a>
										</h4>
									 </div>
									 ...
									 <div class="panel-heading">
										<h4 class="panel-title">
										  <a data-toggle="collapse" data-parent="#accordion-alt3" href="#collapseThree-alt3">
											<i class="fa fa-angle-right"></i> Our Identity
										  </a>
										</h4>
									 </div>
