...
<form method="post" action="php/umembership.php" enctype="multipart/form-data">
<div class="form-row">
...
<textarea  type="name" name="requiredescription" class="form-control" id="arContent" placeholder="Describe yourself here..." cols="100" ></textarea>
...
Edit
</button> <a href="php/umembership.php?del=<?=$data2['id']?>"><button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#exampleModal">
Delete
</button></a></td>
</tr>            
<?php $count++;
