...
$id=$_POST['id'];
$query="SELECT * FROM product_services WHERE id='$id'";
...
$query="UPDATE product_services SET ";
...
$queryrun=mysqli_query($db,$query);
if($queryrun){
    header("location:../?editproductservices=true#done");
}    
...
if(isset($_GET['del'])){
    $id=$_GET['del'];
    $query="DELETE FROM product_services WHERE id='$id'";
    $queryrun=mysqli_query($db,$query);
if($queryrun){
    header("location:../?editproductservices=true#done");
}
...
if($pdone=="error"){
    header("location:../?editproductservices=true&msg=error");
}else{
$query="INSERT INTO product_services(projectname,projectpic,projectlink) ";
$query.="VALUES ('$projectname','$projectpic','$projectlink')";
$queryrun=mysqli_query($db,$query);
if($queryrun){
    header("location:../?editproductservices=true&msg=updated");
}    
