...
?>  
         <form method="post" action="php/uproductservices.php" enctype="multipart/form-data">
  <div class="form-row">
...
<table class="table table-striped table-sm">
          ...
          <tbody>
         <?php
$query2="SELECT * FROM product_services";
...
while($data2=mysqli_fetch_array($queryrun2)){
  ...
  Edit
</button> <a href="php/uproductservices.php?del=<?=$data2['id']?>"><button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#exampleModal">
  Delete
             </button></a></td>
            </tr>            
         <?php $count++;
