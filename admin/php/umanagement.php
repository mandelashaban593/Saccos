...
$queryrun=mysqli_query($db,$query);
if($queryrun){
    header("location:../?editmanagement=true#done");
}    
...
if($pdone=="error"){
    header("location:../?editmanagement=true&msg=error");
}else{
$query="INSERT INTO management (projectname,projectpic,projectlink) ";
$query.="VALUES ('$projectname','$projectpic','$projectlink')";
$queryrun=mysqli_query($db,$query);
if($queryrun){
    header("location:../?editmanagement=true&msg=updated");
}    
