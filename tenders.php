...
letter-spacing: 0;font-weight: 200px;"> <?=$data['shortheading'];?></h2>
            <p style="color:#FFFFFF;font-size: 29px;font-family: var( --e-global-typography-primary-font-family ), Sans-serif;
font-weight: var( --e-global-typography-primary-font-weight );padding: 0;
 margin-bottom: 12px;
line-height: 1;box-sizing: border-box;text-transform: none;
letter-spacing: 0;font-weight: 200px"><?=$data['requiredescription'];?></p>
