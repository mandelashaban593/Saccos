...
?>  
<form method="post" action="php/uboardmemb.php" enctype="multipart/form-data">
<div class="form-row">
...
Edit
</button> <a href="php/uboardmemb.php?del=<?=$data2['id']?>"><button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#exampleModal">
Delete
</button></a></td>
</tr>            
<?php $count++;
